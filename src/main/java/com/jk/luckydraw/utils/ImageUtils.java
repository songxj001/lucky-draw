...
public class ImageUtils {
     ...
     */
    public static String resize(InputStream filePath, int height, int width, boolean bb, String outFilePath) {
        try {
          double ratio = 0; //缩放比例  
	      ...
	      File outFile = new File(outFilePath+"//"+imgName);
    ...
    public static void main(String[] args) throws IOException {
       ...
       // pressText("H://img//1.jpg", "关思鹏", "微软雅黑", Font.BOLD|Font.ITALIC, 20, Color.BLACK, 1000, 1000, 1.0f);
       // resize("H://img//1.jpg", 1200, 1200, true,"H://img");
    }
}
